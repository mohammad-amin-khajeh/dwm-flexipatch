...
static const int vertpad                 = 05;  /* vertical padding of bar */
static const int sidepad                 = 05;  /* horizontal padding of bar */
...
#else
static void (*bartabmonfns[])(Monitor *) = { dwindle /* , customlayoutfn */ };
...
static const MonitorRule monrules[] = {
	...
	{  0,        6,    2,      -1,    -1,      -1,       -1     },
	{  0,        7,    2,      -1,    -1,      -1,       -1     },
	{  0,       -1,    0,      -1,    -1,      -1,       -1     }, // default tile layout for other tags
};
#else
static const MonitorRule monrules[] = {
...
static const int nstack      = 1;    /* number of clients in primary stack area */
...
#if DRAGMFACT_PATCH
static const int refreshrate_dragmfact = 10; /* refresh rate (per second) for dragmfact */
...
static const Key keys[] = {
	...
	{ MODKEY|ControlMask,           XK_o,          setmfact,               {0} },
	#if CFACTS_PATCH
	{ MODKEY|ControlMask,           XK_j,          setcfact,               {.f = +0.08} },
	{ MODKEY|ControlMask,           XK_k,          setcfact,               {.f = -0.08} },
	{ MODKEY|ControlMask,           XK_Up,         setcfact,               {.f = +0.08} },
	{ MODKEY|ControlMask,           XK_Down,       setcfact,               {.f = -0.08} },
